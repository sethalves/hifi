...
namespace controller {
    ...
    Input::NamedVector ActionsDevice::getAvailableInputs() const {
        static Input::NamedVector availableInputs {
            ...
            makeButtonPair(Action::CONTEXT_MENU_CENTERED, "ContextMenuCentered"),
            makeButtonPair(Action::CONTEXT_MENU_LEFT_LASER, "ContextMenuLeftLaser"),
            makeButtonPair(Action::CONTEXT_MENU_RIGHT_LASER, "ContextMenuRightLaser"),
