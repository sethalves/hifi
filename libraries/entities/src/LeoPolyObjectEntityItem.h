...
#ifndef hifi_LeoPolyObjectEntityItem_h
#define hifi_LeoPolyObjectEntityItem_h

#include "EntityItem.h"

class LeoPolyObjectEntityItem : public EntityItem {
 public:
    static EntityItemPointer factory(const EntityItemID& entityID, const EntityItemProperties& properties);

    LeoPolyObjectEntityItem(const EntityItemID& entityItemID);
