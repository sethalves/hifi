...
public:
    ...
    DEFINE_PROPERTY_REF(PROP_PARENT_ID, ParentID, parentID, EntityItemID, UNKNOWN_ENTITY_ID);
    DEFINE_PROPERTY(PROP_HAS_SUBPHYSICS, HasSubphysics, hasSubphysics, bool, false);
