...
var flashlight = Entities.addEntity({
    ...
    grab: {
        equippable: true,
        equippableLeftPosition: {x:0.0806504637002945,
                                 y:0.09710478782653809,
                                 z:0.08610185235738754},
        equippableLeftRotation: {x:0.5630447864532471,
                                 y:-0.2545935809612274,
                                 z:0.7855332493782043,
                                 w:0.033170729875564575},
        equippableRightPosition: {x:0.0717092975974083,
                                  y:0.1166968047618866,
                                  z:0.07085515558719635},
        equippableRightRotation: {x:-0.7195770740509033,
                                  y:0.175227552652359,
